...
k8s-helm-etcd-apply: ${BINARY_HELM} helm-generate $(K8S_POST_GENERATE_TARGETS) ## Generates and installs the helm chart.
	@echo "Apply generated helm chart"
	@${BINARY_HELM} upgrade -i ${ARTIFACT_ID} ${K8S_HELM_TARGET}

.PHONY: k8s-helm-etcd-reinstall
k8s-helm-etcd-reinstall: helm-delete k8s-helm-etcd-apply ## Uninstalls the current helm chart and reinstalls it.

.PHONY: k8s-helm-chart-import
k8s-helm-chart-import: ${BINARY_HELM} k8s-generate helm-generate-chart helm-package-release ## Pushes the helm chart to the k3ces registry.
